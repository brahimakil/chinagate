    ...
    <Dashboard>
      <section className="w-full space-y-4">
        <div className="w-full flex flex-row justify-between items-center">
          <h1 className="text-2xl">Add New Store</h1>
        </div>
        <AddStore />
      </section>
    </Dashboard>
...
function AddStore() {
  ...
  useEffect(() => {
    if (isLoading) {
      toast.loading("Adding Store...", { id: "addStore" });
    }
...
if (data) {
    ...
    setTimeout(() => {
      router.push("/dashboard/admin/list-stores"); // Add this redirect
    }, 1000);
  }
  ...
  return (
    <form className="w-full flex flex-col gap-y-4" onSubmit={handleAddStore}>
      {/* thumbnail */}
      ...
      <div className="w-full flex flex-col gap-y-4 p-4 border rounded">
        <label htmlFor="title" className="w-full flex flex-col gap-y-1">
          ...
          <input
            ...
            name="title"
            id="title"
            placeholder="i.e. China Gate Electronics"
            required
          />
        </label>
      ...
      <div className="w-full flex flex-col gap-y-4 p-4 border rounded">
        <div className="w-full flex flex-row justify-between items-center">
          <span className="text-lg">Store Features</span>
          <button
            type="button"
