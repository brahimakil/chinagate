...
exports.sendPasswordResetEmail = async (email, resetToken) => {
  ...
  const mailOptions = {
    from: process.env.EMAIL_USER,
    to: email,
    subject: "China Deals LB - Password Reset Request",
    html: `
      <div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif;">
        <h2 style="color: #333;">Password Reset Request</h2>
        <p>Hello,</p>
        <p>You requested to reset your password for your China Deals LB account.</p>
        ...
        <p style="color: #666; font-size: 12px;">China Deals LB Team</p>
      </div>
    `,
  };
