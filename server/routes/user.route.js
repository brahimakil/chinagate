...
// add user by admin
router.post("/add-user", verify, authorize("admin"), upload.single("avatar"), userController.addUser);
...
router.get("/dashboard-stats", verify, authorize("admin"), userController.getDashboardStats);

// export data
router.get("/export/:type", verify, authorize("admin"), userController.exportData);
